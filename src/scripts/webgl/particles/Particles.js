...
export default class Particles {
	...
	show(time = 1.0) {
		// reset
		TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 0.5 }, { value: 2.5 });
		TweenLite.to(this.object3D.material.uniforms.uRandom, time, { value: 0.5 });
	...
	resize() {
		console.log("what ->", this.container.position);
